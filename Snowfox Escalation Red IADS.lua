...
SA2sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-2"):FilterActive(true):FilterOnce()
SA3sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-3"):FilterActive(true):FilterOnce()
SA5sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-5"):FilterActive(true):FilterOnce()
SA6sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-6"):FilterActive(true):FilterOnce()
SA8sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-8"):FilterActive(true):FilterOnce()
SA10sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-10"):FilterActive(true):FilterOnce()
SA11sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-11"):FilterActive(true):FilterOnce()
SA13sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-13"):FilterActive(true):FilterOnce()
SA15sam=SET_GROUP:New():FilterPrefixes("rSAM-SA-15"):FilterActive(true):FilterOnce()
EWR=SET_GROUP:New():FilterPrefixes("rEWR"):FilterActive(true):FilterStart()
...
-- REDFOR IADS --
-----------------
redIADS = SkynetIADS:create('IRAN SAMs')
