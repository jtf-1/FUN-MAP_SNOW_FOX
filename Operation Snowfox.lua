...
function SEF_InitializeMissionTable()
	...
	OperationSnowfox_AG[40] = {
		TargetName = "RED SAM Bandar Lengeh SA-11",
		TargetStatic = false,
	...
	OperationSnowfox_AG[62] = {
		TargetName = "RED SAM Havadarya HQ-2",
		TargetStatic = false,
	...
	OperationSnowfox_AG[127] = {
		TargetName = "Bandar-e-Jask - Scud 1",
		TargetStatic = false,
...
function SEF_DisableShips()
	...
	Group.getByName("Bandar-e-Jask - Navy 1"):getController():setOnOff(false)
